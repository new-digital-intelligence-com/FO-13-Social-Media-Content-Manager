...
|---|---|---|
| Composio | Instagram/YouTube/X API calls — posts, comments, DMs, insights | ● Connected / ○ Not connected |
...
|---|---|
| The queue, what is going out, scheduling | Grouped list: **Scheduled** / **Drafts** / **Done**, each row showing local time, relative time, and a state pill. A draft must read as "will not publish". |
...
| Drafting a caption or description | The composer: live character counter against the real platform limit (Instagram 2,200 with a 125 fold marker, YouTube 5,000, X 280) and a per-platform preview. |
| Comments or DMs to answer | Triage list with the drafted reply editable inline, and the original visible beside it. |
| Automations | One card per automation: keywords, targeting (per-post vs account-wide), on/off, and delivered/read/click stats. |
...
"Instagram Queue", "Reel Performance", "Comment Triage". Not "Report" and not a
